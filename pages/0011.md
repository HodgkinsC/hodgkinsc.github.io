			...
			<h1>Find Funky Message's Source</h1>
			<img src="../img/011.gif" width="650px" height="450px" alt="The pictures thread. It has messages that are displayed below.">
			<p>You find the source in the PICTURES thread, but decide to re-read the whole thread as well, for fun.</p>
			<details id="collapse">
				...
				<div class="message">
					<h3>Winter5234 - New User</h3>
					<p id="messagetext"><em>WELL I MEAN</em> actually I'm like 17 so I <em>PROBABLY</em> could, <em>BUUUUUUUUUTTT</em> I don't really want to... :l</p>
					<p>11/03 - 06:58 pm</p>
				</div>
				<div class="message">
					<h3>MikeL57 - Site Admin</h3>
			...
			<p>Well, there it is... Among the many other messages in the thread, there's the small chain about getting photos from the hanging space below the ground near the spire in the !^$#!*$ city centre, on the 14th at like 6am... It's a weird tangent that kinda appeared out of nowhere conveniently... Hmmmmmm. You are glad you've lived here your whole life and understand what that means. You are also glad you know the name of that location and that it doesn't look like nonsense symbols. Man it would suck to not know the actual name of the place and have to deal with a censored version purely because the writer didn't know what to call it. mmm hm... Actually it wouldn't suck that much.</p>
			<p>After that weird meta thought ramble... you realise that it is, in fact, the 14th today... at around 3am... Hmmmmm..... Convenient......</p>
			<p>Well, there's nothing better to do right now! You should probably notify them you're going first, then you can get ready and get going!</p>
			<a href="?p=0012"><h2>> Open Discussion thread</h2><a>
