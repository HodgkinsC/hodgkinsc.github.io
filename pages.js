...
async function setup_page() {
    ...
    //This catches the thrown error and puts a message in the console, as well as going to an error page.
        ...
        document.getElementById("maincontent").innerHTML = "<p>Oopsie, that page couldn't be found!!!<br>Either the url is wrong or the page doesn't exist yet. You'll probably find this page if the newest page is in development but already has a command set.</p><a href='/'><h2>Go to homepage</h2></a>"
    }
}